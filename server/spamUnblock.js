...
const LABEL = {
  ...
  // Telegram ставит анти-бот проверку последним шагом апелляции. Автоматически её не
  // проходим: дошли до конца и передаём человеку — это не поломка модуля.
  captcha: 'жалоба заполнена, @SpamBot просит проверку «я не робот» — завершите вручную',
