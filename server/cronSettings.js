...
export const CRON_FIELDS = [
  ...
  { key: 'statusTickMin', label: 'Возврат из временных статусов: интервал', unit: 'мин', def: 5, min: 1, max: 120,
    hint: 'Через столько аккаунт с истёкшим спамблоком, флудвейтом или карантином вернётся в работу. Раньше это делалось только при перезапуске сервера — то есть могло не делаться сутками.' },
]
