...
export default {
  ...
  blocks: [
    ...
    },
    {
      ...
      howItWorks:
        'Список разбирается на телефоны и юзернеймы. Телефон резолвится в аккаунт Telegram через '
        + 'импорт контакта; если номера в Telegram нет — цель пропускается. Прогресс задачи считается '
        + 'от длины списка: сколько целей, столько и действий.',
