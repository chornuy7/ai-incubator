...
export default {
  ...
  whoAmI: {
    ...
    does: [
      ...
      'работает только в дневном окне 9:00–23:00: активность ночью выдаёт бота',
      'при достижении суточного лимита действия деградируют в безопасный просмотр',
    ],
    doesNot: [
  ...
  blocks: [
    ...
    },
    {
      ...
      howItWorks:
        ...
        + 'тем больше действий в день и тем заметнее аккаунт.',
    ...
    },
    {
      ...
      howItWorks:
        ...
        + 'Поверх работает суточная норма уровня и общий суточный лимит аккаунта.',
    ...
    },
    {
      ...
      howItWorks: 'Прогрев чаще ставят по времени: он должен идти фоном несколько дней.',
  ...
  params: [
      ...
      enum: [
        {
          value: 0,
          label: 'Быстрый (2 дня)',
          means: 'Задержки ×0.8, до 40 действий в день. Быстро, но аккаунт заметнее — для тех, кто нужен срочно.',
        },
        {
          value: 1,
          label: 'Нормальный (3–7 дней)',
          means: 'Задержки ×1.3, до 20 действий в день. Рекомендуемый режим.',
        },
        {
          value: 2,
          label: 'Стандартный (7–14 дней)',
          means: 'Задержки ×2.0, до 10 действий в день. Медленно и максимально похоже на живого человека.',
        },
      ],
      purpose: 'Темп прогрева и суточная норма действий.',
      constraints: ['множитель уровня перемножается с защитой и пресетом, а не заменяет их'],
    ...
    },
    {
      ...
      constraints: ['должен быть ≥ minActions', 'суточную норму уровня не отменяет'],
      examples: [40, 200],
    ...
    },
    {
      ...
      constraints: [
        ...
        'вне окна 9:00–23:00 действия не выполняются в любом случае',
      ],
      examples: [480, 1440],
  ...
  presets: [
    {
      ...
      values: [
        { value: 0, label: 'Быстрый (2 дня)', multiplier: 0.8, actionsPerDay: 40, means: 'Задержки ×0.8, 40 действий в день.', useWhen: 'аккаунт нужен срочно' },
        { value: 1, label: 'Нормальный (3–7 дней)', multiplier: 1.3, actionsPerDay: 20, means: 'Задержки ×1.3, 20 действий в день.', useWhen: 'обычный случай' },
        { value: 2, label: 'Стандартный (7–14 дней)', multiplier: 2.0, actionsPerDay: 10, means: 'Задержки ×2.0, 10 действий в день.', useWhen: 'дорогие аккаунты, спешить некуда' },
      ],
    },
    {
