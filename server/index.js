...
// MR-203: карту погашенных выходом токенов читаем ДО первого запроса. Иначе первый же
// запрос после перезапуска прошёл бы по токену, который человек уже погасил выходом.
await import('./lib/tokenRevocation.js').then((m) => m.ensureLoaded()).catch(() => {})
