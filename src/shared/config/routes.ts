...
export const ROUTES: RouteDef[] = [
  ...
  // пункт и ОДИН экран: список сотрудников, под ним шаблоны доступа, у каждого своя
  // пагинация. Вкладки тут не годятся — они прячут половину раздела, а сценарий сквозной:
  // собрать шаблон и тут же применить его сотруднику. Старый /panel/roles остался рабочим
  // и ведёт сюда же (App.tsx), поэтому сохранённые ссылки внутри панели не ломаются.
