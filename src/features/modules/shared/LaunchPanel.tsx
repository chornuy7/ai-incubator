import { Play, Save, Square, AlertTriangle, Loader2 } from 'lucide-react'
import { cn } from '@/shared/lib/utils'
import type { ModuleTask } from '@/api/modulesApi'
import { LaunchStat } from './index'

export function LaunchPanel({ running, starting, canStart, onStart, onStop, onSave, primaryLabel, stats, task, warn }: {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center gap-3 rounded-2xl border border-line bg-elevated/40 p-4 sm:flex-row">
        ...
        <button type="button" onClick={onSave} className="btn-ghost h-11 text-sm"><Save size={15} /> Сохранить</button>
      </div>
