...
export function AccountOverviewPage() {
  ...
  return (
    // ТЗ 19.08 §5: карточка снова живёт в общей колонке-блоке (кап 1400px вернулся в Layout),
    // поэтому «коридор» справа под плавающие кнопки (Help/Поддержка) больше не нужен — на
    // широких экранах они стоят в поле за блоком, а его резерв делал карточку уже остальных
    // страниц. Высота карточки не меняется: min-h ниже и скролл списка остались как были.
    <div>
