...
export default function App() {
  ...
  if (!sessionUser || userState === 'guest') {
    ...
    return (
      <>
      {/* Правка 20.08: сторож нужен и здесь. /admin доступен «гостю панели», и если человек
          залогинен ТОЛЬКО в админке, в этой ветке сторож раньше не монтировался вовсе —
          админ-сессия жила вечно. Он зональный: на /admin следит за админ-сессией. */}
      <SessionGuard />
      <Routes>
